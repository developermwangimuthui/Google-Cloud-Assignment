...
class storage
{
    ...
    {
        putenv("GOOGLE_APPLICATION_CREDENTIALS=/xampp/htdocs/blog/admin/includes/cloud-assignment-php-firebase-adminsdk-tcp2p-b8a70386b4.json");

        $this->projectId = 'cloud-assignment-php';
