...
<head>
    ...
    <title>Google Cloud Assignment | Settings</title>
    <!-- Bootstrap Core CSS -->
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form action="functions/settings.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputpwd0">Old Password</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-lock"></i></div>
                                                <input type="password" name="old_password" id="Password" class="form-control" id="exampleInputpwd0" placeholder="Enter Old Password" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-lock"></i></div>
                                                <input type="password" name="password" id="Password" class="form-control" id="exampleInputpwd1" placeholder="Enter New Password" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-lock"></i></div>
                                                <input type="password" name="password2" id="ConfirmPassword" class="form-control" id="exampleInputpwd2" placeholder="Confirm New Password" required>
                                            </div>
